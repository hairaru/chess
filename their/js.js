function initBoard () {
	...
	for (var i = 0; i < 8; ++i) {
		...
		for (var j = 0; j < 8; ++j) {
			if (i==1) { //black_pawn
				var piece = {player:"black", type:"pawn", x:i, y:j, img:imgCreator("assets/images/black_pawn.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==6) { //white_pawn
				var piece = {player:"white", type:"pawn", x:i, y:j, img:imgCreator("assets/images/white_pawn.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==0 && (j==0 || j==7)) { //black_tower
				var piece = {player:"black", type:"tower", x:i, y:j, img:imgCreator("assets/images/black_tower.png",i,j), init:true, nb:1};
				tabL[j] = piece;
			}
			if (i==7 && (j==0 || j==7)) {//white_tower
				var piece = {player:"white", type:"tower", x:i, y:j, img:imgCreator("assets/images/white_tower.png",i,j), init:true, nb:1};
				tabL[j] = piece;
			}
			if (i==0 && (j==1 || j==6)) {//black_horse
				var piece = {player:"black", type:"horse", x:i, y:j, img:imgCreator("assets/images/black_horse.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==7 && (j==1 || j==6)) {//white_horse
				var piece = {player:"white", type:"horse", x:i, y:j, img:imgCreator("assets/images/white_horse.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==0 && (j==2 || j==5)) {//black_bishop
				var piece = {player:"black", type:"bishop", x:i, y:j, img:imgCreator("assets/images/black_bishop.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==7 && (j==2 || j==5)) {//white_bishop
				var piece = {player:"white", type:"bishop", x:i, y:j, img:imgCreator("assets/images/white_bishop.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==0 && j==3) {//black_queen
				var piece = {player:"black", type:"queen", x:i, y:j, img:imgCreator("assets/images/black_queen.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==7 && j==3) {//white_queen
				var piece = {player:"white", type:"queen", x:i, y:j, img:imgCreator("assets/images/white_queen.png",i,j), nb:1};
				tabL[j] = piece;
			}
			if (i==0 && j==4) {//black_king
				var piece = {player:"black", type:"king", x:i, y:j, img:imgCreator("assets/images/black_king.png",i,j), init:true, nb:1};
				tabL[j] = piece;
				blackKing=piece;
			}
			if (i==7 && j==4) {//white_king
				var piece = {player:"white", type:"king", x:i, y:j, img:imgCreator("assets/images/white_king.png",i,j), init:true, nb:1};
				tabL[j] = piece;
				whiteKing=piece;
			}
			checkTabL[j] = false;
...
function imgCreator (imgPiece, x, y) {
...
function changePawn (pawn) {
	...
	queen.src = "assets/images/"+pawn.player+"_queen.png";
	bishop.src = "assets/images/"+pawn.player+"_bishop.png";
	horse.src = "assets/images/"+pawn.player+"_horse.png";
	tower.src = "assets/images/"+pawn.player+"_tower.png";
...
function changeInfo(){
	...
	if (mat && tourBlanc && blackKing.img.src!="http://infolimon.iutmontp.univ-montp2.fr/~aboulincp/chess/assets/images/mat.gif-c200" && blackKing.img.src!="file:///C:/Users/ABOULINC/Documents/IUT/Java%20Script/chess/resBis/mat.gif-c200") {
		whiteKing.img.src = "assets/images/mat.gif-c200";
	...
	if (mat && !tourBlanc && whiteKing.img.src!="http://infolimon.iutmontp.univ-montp2.fr/~aboulincp/chess/resBis/mat.gif-c200" && whiteKing.img.src!="file:///C:/Users/ABOULINC/Documents/IUT/Java%20Script/chess/resBis/mat.gif-c200") {
		blackKing.img.src = "assets/images/mat.gif-c200";
		blackKing.img.style.width="60px"
	}
	if (!mat) {
		blackKing.img.src = "assets/images/black_king.png";
		whiteKing.img.src = "assets/images/white_king.png";
	};
}
	...
	document.getElementById("back").onclick = function() {
		if (backTab.length-1 >= 0) {
			...
			if (lastPiece.type == "pawn") {
				lastPiece.piece.img.src = "assets/images/"+lastPiece.piece.player+"_pawn.png";
...
function loadBoard (newtab, newWhiteDead, newBlackDead, newBackTab, time, info) {
	...
	for (var i=0; i < 8; i++) {
		for (var j=0; j < 8; j++) {
			if (typeof tab[i][j] == "object" && tab[i][j] != null) {
				tab[i][j].img = imgCreator("assets/images/"+tab[i][j].player+"_"+tab[i][j].type+".png",i,j);
	...
	for (var i=0; i < whiteDead.length; i++) {
		whiteDead[i].img = imgCreator("assets/images/"+whiteDead[i].player+"_"+whiteDead[i].type+".png",i,i);
	...
	for (var i=0; i < blackDead.length; i++) {
		blackDead[i].img = imgCreator("assets/images/"+blackDead[i].player+"_"+blackDead[i].type+".png",i,i);
